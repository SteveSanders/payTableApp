...
let gameFamilyNames: [String] = ["Jacks or Better Poker", "Bonus Poker", "Bonus Poker Deluxe", "Double Bonus Poker", "Double Double Bonus Poker", "Super Aces Bonus Poker", "Super Double Bonus Poker", "Triple Double Bonus Poker", "Joker Poker Kings or Better", "Deuces Wild Poker", "Deuces Wild Bonus Poker", "Double Bonus Deuces Wild Poker", "Super Double Double Bonus Poker", "White Hot Aces Poker", "Joker Poker 2 Pair", "Joker Poker 2 Pair", "Royal Aces Bonus Poker", "Triple Bonus Poker", "Triple Bonus Poker Plus", "USA Poker", "Aces & Faces Poker", "Double Aces & Faces Poker", "Double Double Aces & Faces Poker", "Black Jack Bonus Poker", "Joker Poker Aces or Better", "Triple Triple Bonus Poker", "Aces$ Bonus Poker", "Deuces Joker Poker", "Ace Invaders Poker", "Double Joker Poker", "Loose Deuces Poker", "One Eyed Jacks Poker", "Shockwave Poker", "Super Bonus Deuces Poker", "Double Bonus Poker Plus", "Double Deuces Poker",  "6s or Better/JB", "6s or Better/QB", "7s or Better", "8s or Better", "One Pair", "Ace Invaders", "Error"]
