...
let MHGameNames: [String] = ["Ace Invaders", "Big Split", "Big Times Draw Poker", "Double Down Stud",  "Double Pay", "Double Pay: Spin", "Double Super Times Pay", "Dream Card", "Fifty Play Draw Poker", "Fifty Play with Quick Quads", "Fifty Play with Super Times Pay", "Five Aces", "Five Play Draw Poker", "Five Play Multi-Strike Poker", "Good Times Pay", "Hot Roll", "Hundred Play with Quick Quads", "Hundred Play with Super Times Pay", "Multi-Strike", "Multi-Strike with Super Times Pay", "Powerhouse", "Quick Quads", "Random Rewards", "Spin Poker", "Spin Poker Deluxe", "Spin with Dream Card",  "Super Times Pay", "Super Times Pay Spin Poker", "Super Triple Play", "Super Triple Play Jackpots", "Triple Spin Poker", "Ten Play Draw Poker", "Triple Play Draw Poker", "Ultimate X - 3 Hand", "Ultimate X - 5 Hand", "Ultimate X - 10 Hand", "Ultimate X Poker Bonus Streak - 3 Hand", "Ultimate X Poker Bonus Streak - 5 Hand", "Ultimate X Poker Bonus Streak - 10 Hand", "Wheel Poker", "Wheel Poker Deluxe - 3 Hand", "Wheel Poker Deluxe - 5 Hand", "Wheel Poker with Quick Quads" ]
